...
## 2. 0.6.2 核心升级
- `.autorunne/state/*` 正式成为唯一事实源
- `.autorunne/views/*.md` 改成可重建的渲染视图
- `open / start / checkpoint / finish / sync / hermes-task` 全部走 state engine
- 新增 repo 级 skill / wrapper 接入：`AGENTS.md`、`.agents/.../SKILL.md`、`.claude/.../SKILL.md`
- 新增 `ar-codex`、`ar-claude`、`ar-hermes`
- 新增 `record / render / show / history / trace`
- `doctor` 现在会检查 state、views、snapshot、integration、wrapper、render rebuild
