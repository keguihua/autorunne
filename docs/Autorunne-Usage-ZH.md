...
然后把 `.autorunne/START_HERE.md` 打开给 Claude Code、Codex、Gemini、Hermes、Cursor 或 GitHub Copilot 继续做开发。
...
接管后优先打开 `.autorunne/START_HERE.md`，直接给 Claude Code / Codex / Gemini / Hermes / Cursor / GitHub Copilot 当作当前项目入口。
