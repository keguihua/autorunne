...
### 7. 安装和发布链路已经跑通
0.6.15 已发布到 GitHub Release 和 PyPI，可以用 `pipx install autorunne` 安装，用 `pipx upgrade autorunne --pip-args '--no-cache-dir -i https://pypi.org/simple'` 升级。
...
## 商业稳定性说法
可以说：
- “0.6.15 已完成 GitHub Release、PyPI、服务器环境、真实课程 demo 的基础验证。”
