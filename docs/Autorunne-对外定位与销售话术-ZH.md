...
## 对外定位
Autorunne 是一个 **本地优先、轻量但可持续交接的 AI 开发工作流内核**。
...
### 3. start → checkpoint → finish 闭环清楚
不是只会“写代码”，而是把：
- 任务开始
- 中途进展
- 最终收尾
...
## 一句话介绍模板
### 短版
Autorunne 是一个让 Claude Code、Codex、Gemini 等 coding agent 持续接力做项目的本地工作流内核。
...
### 话术 3
Claude Code、Codex、Gemini 很适合做实现，但真正把它们串起来、让项目不断档的，是 Autorunne 这层本地工作流。
...
- 多模型共享项目记忆层
- 适合真实开发交付的 AI 工作区
- 面向 Claude Code / Codex / Gemini 的 repo-local workflow layer
