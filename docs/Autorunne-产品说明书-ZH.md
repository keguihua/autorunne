...
- 0.6.14/0.6.15 起补齐轻量 Python 教学项目识别，并让 Codex、Claude、Hermes、Cursor、Copilot 的 repo 入口都自动回到同一套 Autorunne 工作流
...
- 0.6.15 已完成 GitHub Release、PyPI、Hermes 服务器 venv、真实课程开发项目 smoke test 四层验证

## 商业稳定性结论
0.6.15 可以作为早期商业演示和教学/交付工作流的稳定版本使用，适合用来证明：
